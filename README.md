...
<p text-align="justify"> Neste projeto, foi criado um aplicativo da Web que permita ao usuário 
...
Nele, fui desafiada a criar uma interface que deve permitir ao usuário: </p>
...
<p text-align="justify"> Atráves do **Algoritmo de Luhn**, também conhecido como “Algoritmo do Módulo 10”,
é uma fórmula  de soma de verificação simples, usada para determinar se o número 
de identificação do cartão de crédito fornecido por um usuário é válido. </p>

***

## DEFINIÇÃO DO PRODUTO

 <p text-align="justify"> O aplicativo web de validação do cartão de crédito **SAÚDE VALIM**, foi planejada com 
...
se o campo do número do cartão estiver vazio, é solicitado que o mesmo preencha. </p>


## Nível de EXPERIÊNCIA e INTERFACE 

 <p text-align="justify"> A interface do usuário (UI), ou seja, a parte visual desse projeto, foi pensada
...
visual dessa plataforma e tornando-a reconhecível. </p>


<img src= "src/paleta1.png" width = "350px" height = "420px"/>  <img src= "src/paleta2.png" width = "350px" height = "420px"/>


<p text-align="justify">  Tanto a interface, quanto a experiência do usuário, foram pensadas e baseadas
...
simples, intuitiva e até mesmo interessante de ser utilizada pelo público-alvo. </p>
